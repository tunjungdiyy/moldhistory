...
public class ReviewTotalRepairMoldController {
    public HBox btnCanceled;
    public TableView<ProductMoldReview> tableMold;
    public TableColumn<ProductMoldReview, String> columnName;
    public TableColumn<ProductMoldReview, String> columSerialNumber;
    public TableColumn<ProductMoldReview, String> columnCvt;
    public TableColumn<ProductMoldReview, String> columnVertical;
    public TableColumn<ProductMoldReview, String> columnHorizontal;
    public TableColumn<ProductMoldReview, String> columnThickness;
    public TableColumn<ProductMoldReview, String> columnDescription;
    public TableColumn<ProductMoldReview, String> columnCountOfProblem;
    ...
    ObservableList<ProductMoldReview> productMoldReviewObservableList;
    
    AlertApp alertApp = new AlertApp();
    
    public void initialize() {
        productMoldReviewList = productMoldService.reviewMold();
        
        addDataTableProductMold(productMoldReviewList);
    }
    ...
    public void fncPdf(ActionEvent actionEvent) {
        try {
            ...
            File pdfFile = PdfDirectoryConfig.getPdfFile("rekap-kerusakan-mold.pdf");
            ...
            Paragraph title = new Paragraph("REKAP KERUSAKAN MOLD", big);
            ...
            table.setWidths(new float[]{3f, 2f, 1f, 2f, 2f, 2f, 3f, 1f});

            String[] titleTable = {"NAMA PRODUK", "NO SERI", "CVT", "VERTICAL", "HORIZONTAL", "THICKNESS", "KETERANGAN", "TOTAL"};
            ...
            for (ProductMoldReview productMold : productMoldReviewList) {
                ...
                table.addCell(String.valueOf(productMold.getCountProblem()));
            }

            Paragraph count = new Paragraph("Jumlah Mold : " + String.valueOf(productMoldReviewList.size()), normal);
    ...
    public void fncExcel(ActionEvent actionEvent) throws IOException {
        ...
        Sheet sheet = workbook.createSheet("rekap-kerusakan-mold");
        ...
        String[] columns = {"NAMA PRODUK", "NO SERI", "CVT", "VERTICAL", "HORIZONTAL", "THICKNESS", "KETERANGAN", "TOTAL"};
        ...
        for (ProductMoldReview productMold : productMoldReviewList) {
            ...
            row.createCell(7).setCellValue(String.valueOf(productMold.getCountProblem()));
        }
        ...
        countDataTable(sheet, productMoldReviewList, workbook);

        // date export
        setFooterdateExport(sheet, workbook);

        // ======= Tentukan direktori tujuan =======
        File fileexcel = PdfDirectoryConfig.getXlxs("rekap-kerusakan-mold.xlsx");
    ...
    void addDataTableProductMold(List<ProductMoldReview> list) {
        ...
        columnCountOfProblem.setCellValueFactory(param -> new javafx.beans.property.SimpleStringProperty(String.valueOf(param.getValue().getCountProblem())));

        productMoldReviewObservableList = FXCollections.observableList(list);

        tableMold.setItems(productMoldReviewObservableList);
    }
    ...
    void countDataTable(Sheet sheet, List<ProductMoldReview> list, Workbook workbook) {
        // ambil baris setelah data terakhir
    ...
    void setTitle(Sheet sheet, Workbook workbook) {
        ...
        titleCell.setCellValue("REKAP KERUSAKAN MOLD");
        ...
        sheet.addMergedRegion(new org.apache.poi.ss.util.CellRangeAddress(
                ...
                0, // baris akhir
                0, // kolom awal
                7  // kolom akhir (sesuaikan jumlah kolom)
        ));
